...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////      favourites products           //////////////////////////////////
let favProducts=localStorage.getItem("favourites")?JSON.parse(localStorage.getItem("favourites")):[]
if(favProducts==[]){
  let favProductsSection=document.querySelector(".fav-products");
  favProductsSection.style.display="none"

}
let favProductsDiv=document.querySelector(".fav-products-content .row")
function drawFavProducts(products){
    let element=products.map((item)=>{
        ...
        <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="fav-card">
                  ...
                  <div class="fav-card-body ms-3">
                    <div class="fav-name">
                      <p>Product: ${item.name}</p>
                    </div>
                    <div class="fav-category">
                      <p>Category: ${item.category}</p>
                      <i class="far fa-heart fav text-danger" onClick="removeFav(${item.id})"></i>
                    </div>
                  </div>
                </div>
        </div>
    ...
    favProductsDiv.innerHTML=element.join("")
}
drawFavProducts(favProducts)
///////////////////////////////////////        remove favourites products           ///////////////////////////////////
